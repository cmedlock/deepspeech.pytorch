...
CM: Documentation of summer 2018 internship project using Sean Naren's implementation of DeepSpeech2. Comments that I added to the existing documentation are marked with 'CM'. Files that I added or modified have the suffix '_cm'.
...
CM: Follow instructions from [here](https://kheafield.com/code/kenlm/),
